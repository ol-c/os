...
test_vm_runs_firefox_borderless_and_maximized() {
  ...
  [[ "$contents" == *"<title>ol-c</title>"* ]] || fail "expected VM home tab title to use product branding"
  [[ "$contents" == *"<h1>ol-c control surface</h1>"* ]] || fail "expected VM home heading to use product branding"
